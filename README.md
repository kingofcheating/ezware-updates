...
> [!NOTE]
> **Built with safety-first defaults:** ezware starts in read-only mode, runs as a separate application without DLL injection, and stores profiles locally. Always download from this official repository and use it only in authorized environments.
