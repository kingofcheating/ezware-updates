...
## **➡️ [Download the latest version](https://github.com/kingofcheating/ezware-updates/releases/latest) ⬅️**
...
They aren't stored in a temporary folder, so clearing temporary files won't delete them.

If possible, configs from older versions are automatically moved to the new location.
